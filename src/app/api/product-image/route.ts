 ...
 * and cached.
 *
 * Reuses the exact parser used by scripts/reingest-images.mjs.
 *
 * Cache: in-memory Map keyed by lowercased query. Hits return instantly;
 * misses cache the null result too so we don't re-hammer Bing for items
 * with no good match.
 *
